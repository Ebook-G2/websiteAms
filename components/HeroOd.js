  ...
  <div className="relative text-center ">
      ...
      <div className='flex flex-row items-center whitespace-nowrap'>
        <Link href={'/'}>
          <motion.p 
            ...
            className="text-white font-medium text-3xl max-sm:text-sm uppercase py-3 drop-shadow-lg custom-shadow">
            Home /
          </motion.p>
        </Link>
        <motion.span
    ...
    <div className="relative item h-[45rem] overflow-hidden">
      <Image
        ...
        alt="ai hero image"
        className="w-full h-auto object-cover max-h-[45rem] max-sm:h-[15rem] max-md:h-[22rem] brightness-95" 
        width={1280}
        height={700}
      />
    </div>
