          ...
          <div className="flex flex-col w-1/2 max-sm:w-full max-lg:w-full">
            ...
            <section className="max-sm:text-base">
              <p className="text-justify">
                ...
                <span className="font-semibold">Data Analytics</span>, optimizes
                keywords and measures video performance. All of these help
                businesses increase interactions and maximize communication
            ...
            {about.map((about, index) => (
              <section className="pt-6 flex items-center" key={index}>
                <img
                  ...
                  height={10}
                />
                <p className="font-semibold pl-6 max-sm:text-base max-lg:text-lg">
                  {about.title} -
